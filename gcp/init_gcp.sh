...
gcloud compute instances create-with-container el-service-vm --machine-type e2-micro --container-image us-east1-docker.pkg.dev/algus-project-382/algus-docker-repo/el-service:tag1 --container-env STORAGE_TYPE=GS
